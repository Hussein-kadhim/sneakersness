        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 sm:h-20">
                ...
                <nav class="navbar hidden md:flex items-center gap-1.5 text-sm font-medium">
                    ...
                    <a href="{{ route('tickets.index') }}" class="w-full md:w-auto px-3.5 py-1.5 text-orange-600 bg-orange-50 font-semibold rounded-lg">
                        Tickets
                    </a>
                            ...
                            <tbody class="divide-y divide-slate-100 text-sm">
                                @foreach($tickets as $ticket)
                                    ...
                                    <tr class="hover:bg-slate-50 transition-colors">
                                        ...
                                        <td class="py-4 px-6 whitespace-nowrap">
                                            <span class="inline-flex items-center px-2.5 py-1 rounded text-xs font-semibold {{ $ticket->status_color_class }}">
                                                {{ $ticket->status_label }}
                                            </span>
                                        </td>
